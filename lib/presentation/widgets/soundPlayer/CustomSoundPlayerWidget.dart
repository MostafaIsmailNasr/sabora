...
class VoiceMessageV2 extends StatefulWidget {
  VoiceMessageV2({
    Key? key,
    required this.me,
    this.audioSrc,
  ...
  _VoiceMessageV2State createState() => _VoiceMessageV2State();
}

class _VoiceMessageV2State extends State<VoiceMessageV2>
            ...
            child: !_audioConfigurationDone
                ? Container(
                    ...
                    child: const CircularProgressIndicator(
                        strokeWidth: 1, color: Color(0xff000000)
